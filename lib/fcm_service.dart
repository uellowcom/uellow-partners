// =============================================================================
// FcmService — Firebase Cloud Messaging glue (fleet push, v1.2.0).
...
// the Uellow push engine can target this partner.
// =============================================================================
import 'dart:async';
...
class FcmService {
  ...
  Future<void> _register(String token) async {
    try {
      ...
      await PartnersApi.instance.registerPushToken(id, token);
    } catch (_) {}
  }
}
